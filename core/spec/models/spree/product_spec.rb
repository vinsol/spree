...
describe Spree::Product, :type => :model do
  ...
  describe 'Associations' do
    it { is_expected.to have_many(:promotions).class_name('Spree::Promotion').through(:promotion_rules) }
    it { is_expected.to have_many(:possible_promotions).class_name('Spree::Promotion').through(:promotion_rules).source(:promotion) }
  end
